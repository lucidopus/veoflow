...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-xl border border-border dark:border-muted-foreground/20 bg-card text-card-foreground shadow',
      className
    )}
    {...props}
  />
...
/**
 * CardTitle - Title within the card
 */
...
/**
 * CardDescription - Description within the card
 */
